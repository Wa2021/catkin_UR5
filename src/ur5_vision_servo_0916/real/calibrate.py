...
# --------------- Setup options ---------------
tcp_host_ip = '192.168.0.1' # IP and port to robot arm as TCP client (UR5)
tcp_port = 30003
...
workspace_limits = np.asarray([[-0.5, 0.5], [-0.5, 0.5], [0.1, 0.6]])

calib_grid_step = 0.05 #0.05
#checkerboard_offset_from_tool = [0,-0.13,0.02]  # change me!标定板到相机末端的距离
